...
#       - b is even pand c is less than or equal to a
...
# TODO: Ask the user to input two numbers and store them in variables 'num1' and 'num2'r to input an operation (+, -, *, /) and store it in a variable called 'operation'
